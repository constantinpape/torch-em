...
python export_bioimageio_model.py -c checkpoints/affinity_model_default -i /g/kreshuk/data/cremi/original/sample_A+_20160601.hdf -o ../../exported_models_mws/cremi -a 0 #-f torchscript onnx
cd ../..
