...
from torch_em.data.datasets.electron_microscopy import get_janelia_nucleus_loader
from torch_em.data.datasets.electron_microscopy.janelia_nucleus import DATASETS

sys.path.append("..")


def check_janelia_nucleus(dataset_names, patch_shape, n_samples):
    from util import ROOT

    loader = get_janelia_nucleus_loader(
        path=os.path.join(ROOT, "janelia_nucleus"),
...
def main():
    ...
    check_janelia_nucleus(args.dataset_names, tuple(args.patch_shape), args.n_samples)
