...
from torch_em.data.datasets.electron_microscopy import get_npc1_mito_loader

sys.path.append("..")


def check_npc1_mito(patch_shape, n_samples):
    from util import ROOT

    loader = get_npc1_mito_loader(
        path=os.path.join(ROOT, "npc1_mito"),
...
def main():
    ...
    check_npc1_mito(tuple(args.patch_shape), args.n_samples)
